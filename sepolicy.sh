...
magiskpolicy --live "dontaudit { system_app priv_app platform_app untrusted_app_29 untrusted_app_27 untrusted_app } { hal_audio_default_exec mtk_hal_audio_exec audioserver_exec } file getattr"
magiskpolicy --live "allow     { system_app priv_app platform_app untrusted_app_29 untrusted_app_27 untrusted_app } { hal_audio_default_exec mtk_hal_audio_exec audioserver_exec } file getattr"
